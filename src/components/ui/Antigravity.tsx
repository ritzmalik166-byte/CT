...
export interface AntigravityProps {
  ...
  /** How quickly the magnet center follows the pointer (0–1, higher = snappier). */
...
const AntigravityInner = ({
  ...
  useFrame((state) => {
    ...
    virtualMouse.current.x +=
      (destX - virtualMouse.current.x) * mouseFollowSpeed;
    virtualMouse.current.y +=
      (destY - virtualMouse.current.y) * mouseFollowSpeed;
